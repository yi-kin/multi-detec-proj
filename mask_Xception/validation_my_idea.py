...
class ClsD(nn.Module):
    def __init__(self,xception):
        ...
        for name,param in self.net.xcep.named_parameters():
            if name in ["net.bn4.weight","net.bn4.bias","net.conv4.conv1.weight","net.conv4.conv1.bias","net.conv4.pointwise.weight","net.conv4.pointwise.bias"]:
                print("yes")
...
#Xception--model############################
    ...
    cnn_sd = torch.load('3new_Xception_epoch.pth', map_location="cpu")
...
#############################################
    ...
    wk = torch.load('3new_epoch.pth',map_location="cpu")
    model_cls.load_state_dict(wk)

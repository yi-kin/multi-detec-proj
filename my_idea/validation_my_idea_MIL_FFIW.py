...
########################################
    for epoch in range(n_epoch):
        ...
        torch.save(model_cls.state_dict(),'./outputs/FFIW_CLS_MIL_{}epoch-(test-auc:{}).pth'.format(epoch,auc))
        torch.save(model1.state_dict(),'./outputs/FFIW_xcep_MIL_{}epoch-(test-auc:{}).pth'.format(epoch,auc))

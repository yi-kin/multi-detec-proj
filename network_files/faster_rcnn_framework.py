...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        rpn = RegionProposalNetwork(
            ...
            score_thresh=rpn_score_thresh) #rpn_batch_size_per_image指在计算损失时，使用的正负样本个数
        #rpn_pre_nms_top_n 指在使用nms前，每个特征层保留的个数
        #rpn_post_nms_top_n 指rpn输出的数目
        # rpn_nms_thresh使用nms的阈值

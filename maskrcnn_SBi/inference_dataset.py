...
if __name__=='__main__':
    ...
    parser.add_argument('-w',dest='weight_name',default='D:\dachuang_python\SelfBlendedImages-master\weights\FFraw.tar',type=str)
    parser.add_argument('-d',dest='dataset',default='CDF',type=str)
